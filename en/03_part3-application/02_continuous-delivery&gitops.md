...
Git is used because  
**it exists as a structure for managing change**

![Figure 3-2: The Difference in Assumptions Between Cloud and On-Premise](../08_img/03/figure_3-2_v3.svg)
...
ArgoCD and Flux  
compare the state in Git with the state of the cluster,  
