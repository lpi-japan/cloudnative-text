...
It is a change in which **the units that make up a system are decomposed,  
and responsibility is allocated to each**.
...
treating as a single unit is the assumption.
