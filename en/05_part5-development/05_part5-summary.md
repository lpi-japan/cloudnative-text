...
was separating execution units, delegating control to the mechanism, and abstracting the environment.

All of this is a decomposition of responsibility — of what to take on, and how far.

In Part 5, how that division of responsibility influences ways of working, value, cost, and AI was examined.

Even when handling the same technology, the value provided is entirely different  
depending on how far one treats as within their own responsibility.
