...
This domain covers the foundational concepts of cloud native:  
containers, microservices, declarative management, and related thinking.

> "**Why did containers become necessary?**"

### 2: Kubernetes and Container Orchestration (Making distribution manageable.)

This domain covers the basic building blocks — Pod, Node, Control Plane, Service —  
and the management structure of distributed environments.
...
This domain covers microservice design, APIs, stateless structures,  
and the design thinking that takes change and scalability as given.
...
This domain covers the mechanisms of connection and communication in distributed environments:  
Service, DNS, Ingress, and related components.
