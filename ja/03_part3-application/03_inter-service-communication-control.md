...
通信の振る舞いを各サービスに任せた場合、挙動はばらつき、原因の特定が困難になる。

**通信は、放置すると制御できなくなる**

通信は、成功することもあれば、失敗することもあり、遅延することもある。  
...
![図3-3 通信制御の置き場所](../08_img/03/figure_3-3_v3.svg)

通信制御の設計とは、複雑さをなくすことではなく、どこに置くかを決めることだ。  
